...
namespace Revolution.Core
{
    class CollisionTest
    {
        ...
        /// </summary>
        private static bool CheckPointInTriangle(Vector3 P, Vector3 A, Vector3 B, Vector3 C)
        {
            //Distance Vectors        
            Vector3 p1 = C - A;
            Vector3 p2 = B - A;
        ...
        /// </summary>
        public static void CheckTriangle(ref CollisionPacket colPackage, Vector3 p1, Vector3 p2, Vector3 p3)
        {
            // Make the plane containing this triangle.
            Plane trianglePlane = new Plane(new Vector3[]{p1, p2, p3});
            ...
            if (true)
            {
                ...
                if (!embeddedInPlane)
                {
                    ...
                    planeIntersectionPoint =
                        (trianglePlane.IsFrontFacingTo(colPackage.NormalisedVelocity)) ?
                    ...
                    if (CheckPointInTriangle(planeIntersectionPoint, p1, p2, p3))
                    {
                        ...
                        //colPackage.CzollisionTri.v1 = p1;
